...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_to_html_node(self):
        ...
        text_node_text = TextNode("this is text", TextType.TEXT.value)
        text_node_bold = TextNode("this is bold", TextType.BOLD.value)
        text_node_italic = TextNode("this is italic", TextType.ITALIC.value)
        text_node_code = TextNode("this is code", TextType.CODE.value)
        text_node_link = TextNode("this is link", TextType.LINK.value, "https://www.google.com")
        text_node_image = TextNode("this is image", TextType.IMAGE.value, "https://www.google.com/images")
